...
int main()
{
    // signed can store negative and positive both value.
    ...
    // Compiler error because unsigned cannot store negative value.
    ...
    return 0; std::cout << "Int variable :  " << int_var <<" , size : "
        << sizeof (int) << " bytes" << std::endl;
