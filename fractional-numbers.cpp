...
int main()
{
    ...
    // Infinity and Nan
    std::cout << std::endl; // To create an empty line
    ...
    std::cout << number10 << "/" << number11 << "  yields " << result << std::endl;// both gives -infinty(-inf)
    std::cout << result << " + " << number10 << " yields " << result + number10 << std::endl;// both gives -infinty(-inf)

    // NaN
    result = number11 / number12; // Not a number
