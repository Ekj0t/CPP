...
int main()
{
    ...
    */
    ...
    std::cout << "------------------" << std::endl;
    auto result1 = func3(23, 7);
    auto result2 = func3(9, 45);
    std::cout << "result1 : " << result1 << std::endl;
    std::cout << "result2 : " << result2 << std::endl;
    std::cout << "direct call : " << func3(5, 2) << std::endl;
    ...
    auto result5 = func5(a, b);
    std::cout << "------------------" << std::endl;
    std::cout << "result4 : " << result4 << std::endl;
    std::cout << "result4 : " << result5 << std::endl;
    std::cout << "sizeof(result3) : " << sizeof(result4) << std::endl; // 4
    std::cout << "sizeof(result4) : " << sizeof(result5) << std::endl; // 8
